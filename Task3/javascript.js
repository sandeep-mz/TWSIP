...
//  ---------scroll for best electronic product -------------------------
bestofElctronic_product_itemEl.innerHTML = bestofElectornicProduct_html

document.getElementById("preve_imageBtnn").addEventListener("click", function () {
    const container = document.getElementById("scrollContainer");
    container.scrollLeft -= 100; // Adjust the scroll distance as needed
});

document.getElementById("next_imageBtnn").addEventListener("click", function () {
    const container = document.getElementById("scrollContainer");
    container.scrollLeft += 100; // Adjust the scroll distance as needed
});
